...
public class LoginActivity extends AppCompatActivity {
     ...
     * login request
     */
    public void LoginAuthenfication() {
        ...
        String url = "http://ec2-54-190-5-108.us-west-2.compute.amazonaws.com/Dashi/LoginServlet?user_id=" + user_name + "&password=" + password;
